...
page = requests.get('https://www.societyforscience.org/press-release/16-year-old-engineer-works-to-improve-spinal-surgery-using-machine-learning-and-computer-vision-full-awards/')
